...
function createForm() {
  ...
  var create_tooltip = function (elem, text) {
    ...
    if (elem.type != 'radio' && elem.type != 'checkbox') {
      ...
      inner.style = 'color: red; font-size: 0.8em';
      ...
      if (elem.type == 'radio' || (elem.type == 'checkbox' && /any/.test(elem.className))) {
        ...
        for (var i = 0; i < elems.length; i++) {
          ...
          if (!elems[i].checked) {
            ...
            err.push("Preenchimento obrigatório".replace("%s", elems[i].value));
          }
        }
        if (!no_error) {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://renaned6841.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
